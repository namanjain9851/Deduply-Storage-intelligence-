...
# Use a high limit in DEBUG so local/testing doesn't hit 429
RATE_LIMIT_CALLS = 100 if DEBUG else 2  # Number of calls allowed
RATE_LIMIT_WINDOW = 1  # Time window in seconds

# Storage Limit Configuration (easily adjustable)
